  ...
  return (
    <section id="home" className="min-h-[90vh] flex items-center pt-20 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-blue/10 rounded-full blur-3xl opacity-40 animate-pulse" style={{ animationDuration: '15s' }}></div>
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-purple/10 rounded-full blur-3xl opacity-30 animate-pulse" style={{ animationDuration: '20s' }}></div>
      ...
      <div className="section mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
          ...
          <div className="md:col-span-5 order-1 md:order-2 flex justify-center">
            <div className="relative animate-fade-in md:translate-x-[-10%]" style={{ animationDelay: "300ms" }}>
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue to-purple rounded-full blur-xl opacity-50 animate-pulse"></div>
              <div className="relative rounded-full overflow-hidden h-72 w-72 border-2 border-white/10">
